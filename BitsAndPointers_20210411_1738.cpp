...
void savingFloatBitsIntoInt(float x) {
    cout << "float      x = " << x << "         = " << bitset<64>(x) << endl;
    cout << "I am now trying to copy these bits onto an long because I once saw that in an interesting algorithm in some game\n";
    float* pointerX = &x;
    long z = * ((long*) pointerX);
    cout << "long        z = " << z << "       = " << bitset<64>(z) << "\n\n";
}
...
int main()
{
    ...
    *pointer = number + 1;
    ...
    cout << "I found the algorithm again: https://youtu.be/p8u_k2LIZyo\n";
    cout << "I honestly dunno what I'm doing... :(\n";
}
